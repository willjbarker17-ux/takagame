...
- **Middleware & Request User**: If requireUser is part of the route middleware, then req.user will be filled with the payload in types/index.ts
...
NEVER proactively create documentation files (\*.md) or README files. Only create documentation files if explicitly requested by the User.# CLAUDE.md
